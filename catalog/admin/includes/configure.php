<?php
  ...
  define('HTTPS_SERVER', 'http://localhost.53');
  define('ENABLE_SSL', false);
  define('HTTP_COOKIE_DOMAIN', '');
  define('HTTPS_COOKIE_DOMAIN', '');
  define('HTTP_COOKIE_PATH', '/oscommerce2/catalog/admin');
  define('HTTPS_COOKIE_PATH', '/oscommerce2/catalog/admin');
  ...
  define('DIR_WS_HTTPS_ADMIN', '/oscommerce2/catalog/admin/');
  ...
  define('DB_DATABASE', 'oscommerce2_v2.3.4');
